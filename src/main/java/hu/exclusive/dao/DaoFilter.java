...
public class DaoFilter {
    ...
    public static final Date MINDATE = new Date(-5364666000000L); // '1800.01.01' Fontos, mert a Long.MIN-re nem talál semmit, az
                                                                  // egy értelmetlen nagy datum, hiaba MIN
    public static final Date MAXDATE = new Date(32503676400000L); // '3000.01.01' Fontos, hogy a Long.MAX-ra nem müködik
...
/**
     * Realation should be in: 'in', 'like', '==', '!=', '>=', '<=', '>', '<', 'notnull', 'isnull', 'between'
     * <br>
     * Values should be: String, Integer, Double, java.util.Date, Collection<T>, null
     * 
     * @param fieldName
     * @param relation
     * @param values 
...
/**
 *  Relation should be in: 'in', 'like', '==', '!=', '>=', '<=', '>', '<', 'notnull', 'isnull', 'between'
 *  subEntity should be related Entity property entity  or entities class. 
 * @param subEntity
 * @param fieldName
 * @param relation
 * @param anyValue
 */
    ...
    /**
     * Visszaadja az elso filtert amire igazak a paraméterek. Null values esetén azt nem veszi figyelembe, csak a field adataival
     * megtalált első filtert adja vissza. Ahol egy filter több értékkel is szerepelhet, ott addig kell hívni, amíg nem null a
     * találat.
     * 
     * @param fieldName
     * @param relation
    ...
    public boolean equals(Object obj) {
        ...
        return ("" + this._fieldName + this._relation + ObjectUtils.nv(this._values)).equals("" + df._fieldName + df._relation
                + ObjectUtils.nv(df._values));
    }
